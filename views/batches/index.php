...
<div class="card">
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <a href="/batches/create" class="btn btn-primary">+ Nouveau batch</a>
        </div>
                ...
                <tbody>
                    <?php foreach ($batches as $batch): ?>
                        <tr>
                            ...
                            <td><? = htmlspecialchars($batch['type']) ?></td>
                            <td><?= date('Y-m-d', strtotime($batch['created_at'])) ?></td>
                            <td>
                                <a href="/batches/<? = $batch['id'] ?>" class="btn btn-sm btn-primary">Ouvrir</a>
                                <a href="/batches/delete/<?= $batch['id'] ?>" 
